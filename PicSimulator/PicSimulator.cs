...
namespace PicSimulator
{
    class PicSimulator : INotifyPropertyChanged
    {
        ...
        private double[] quarzFaktor = {
            122.07, 8.00, 4.00,2.00,1.628,1.333,1.221,1.087,1.085,1,0.977,0.954,0.902,0.814,0.8,0.667,0.651,0.640,0.610,0.5,0.4,0.333,0.25,0.2,0.167,0.125,0.100,0.050
        };
